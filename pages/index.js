                  ...
                  <section className="section-box">
                    ...
                    <div className="container mt-30">
                        ...
                        <p className="text-body-Paragraph color-gray-600 mt-20">
                                ...
                                services and employment by leveraging cutting edge technology technology is our offering
                                </p>
                    ...
                    <div className="container mt-30">
                        ...
                        <div className="mt-30 text-center ">
                                        <Link href="#" legacyBehavior>
                                            <a className="btn btn-default btn-white icon-arrow-right">Learn more</a></Link>
                                    </div>
...
{/* Browse our service starts here */}
<section className="section-box">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-2 col-sm-1 col-12" />
                        ...
                        <div className="text-center mt-40">
                            <ul className="nav" role="tablist">
                                <li onClick={() => handleOnClick()}>
                                    ...
                                    <Link href="" legacyBehavior>
                                        <a className={activeIndex === 1 ? "btn btn-default btn-bd-green-hover btn-select active" : "btn btn-default btn-bd-green-hover btn-select"}style={buttonStyle}>Behavioural Support </a>
                                    </Link>
                                </li>
                                ...
                                <li onClick={() => handleOnClick(1)}>
                                <Link href="#" legacyBehavior>
                                        <a className={activeIndex === 1 ? "btn btn-default btn-bd-green-hover btn-select active" : "btn btn-default btn-bd-green-hover btn-select"} style={buttonStyle}>Occupational Therapy</a>
                                    </Link>
                                </li>
                                <li onClick={() => handleOnClick(1)}>
                                <Link href="#" legacyBehavior>
                                ...
                                <li onClick={() => handleOnClick(1)}>
                                <Link href="#" legacyBehavior>
                                        <a className={activeIndex === 1 ? "btn btn-default btn-bd-green-hover btn-select active" : "btn btn-default btn-bd-green-hover btn-select"} style={buttonStyle}>Training</a>
                                    </Link>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="container">
                        <div className="tab-content">
                            <div className={activeIndex === 0 ? "tab-pane fade  active show" : "tab-pane fade "}>
                    ...
                    <div className="container mt-30">
                        <div className="row">
                        <div className="mt-30 text-center ">
                                        <Link href="#" legacyBehavior><a className="btn btn-default hover-up icon-arrow-right-white btn-top">Browse All</a></Link>
                                    </div>
                           
                        </div>
                    </div>
                </section>
    {/* Browse our service ends here */}
