                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-md-8">
                                    ...
                                    <div>
                                        <p className="" style={{ display: 'inline-block', marginLeft: '0rem' }}>Kingston Heights, Kingston Beach,</p>
                                        <p style={{ marginLeft: '.1rem' }}>TAS 7050</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-4">
                                    ...
                                    <div className="d-flex  align-items-center mb-5">
                                        ...
                                        <p className="mb-0" style={{ fontSize: "24px", marginLeft: "10px" }}>03 6310 8118</p>
                                    </div>
                                    <br />
                                    <div className="d-flex align-items-center">
                                        <i className="fas fa-envelope fa-2x mr-2" style={{ fontSize: "24px", marginLeft: "0px" }}></i>
                                        <p className="mb-0" style={{ fontSize: "24px", marginLeft: "10px" }}>contact@ppm.email</p>
                                    </div>
                                </div>
                            </div>
                        </div>
